...
def get_banner(banners_file):
    ...
    if day == 25 and month == 12:
        parts = loaded_banners["christmas"].splitlines()
    elif day == 31 and month == 10:
        parts = loaded_banners["halloween"].splitlines()
    elif day == 1 and month == 1:
        parts = loaded_banners["new-year"].splitlines()
    else:
        parts = loaded_banners["default"].splitlines()

    for part in parts:
        banner = banner + part.center(console_columns) + "\n"
